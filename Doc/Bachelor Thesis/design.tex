...
MongoDB poskytuje prvky relačných databáz, ktoré ešte rozširuje o ďalšiu funkcionalitu sú zobrazené v tabuľke~\fullref{table:features_of_mongodb} a rozdiely v názvoch sú zobrazene v tabuľke~\fullref{table:names_of_mongodb}, kde bol ako zástupca relačných databáz vybraná MySQL databáza).
