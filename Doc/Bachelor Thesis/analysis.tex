...
\begin{my_itemize}
	\myitem Hodnota pôvodnej a novej vety
	\myitem Zoznam indexov slov, za ktorými bola v poznámke ukončená veta (ak pôvodná veta je súvetie, tak z nej môže vzniknúť viacero poznámok)
	\myitem Všetky závislostí slov v pôvodnej vete
	\myitem Všetky závislosti slov v poznámke
\end{my_itemize}
pričom každá závislosť slov vo vete sa skladá z 
\begin{my_itemize}
	\myitem Názvu závislosti
	\myitem Hodnota governora závislosti
	\myitem Hodnota dependenta závislosti
	\myitem Pozícia závislosti vo vete
	\myitem POS značka a index slova pre governora aj dependenta
\end{my_itemize}
